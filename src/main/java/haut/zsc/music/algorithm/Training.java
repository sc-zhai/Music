...
import haut.zsc.music.algorithm.base.Sample;
import haut.zsc.music.algorithm.base.Edge;
import haut.zsc.music.algorithm.base.Operator;
import haut.zsc.music.algorithm.base.SGD;
...
public class Training {
	...
	public static Map<Integer, float[]> train(List<Song> engSongList, final Map<String, int[]> w2wNetwork,
		...
		for(Song song:engSongList) {
			...
			lyricEmbedding.put(song.getId(), e);
		}
