...
import haut.zsc.music.service.Impl.SongListServiceImpl;
...
public class SongListController {
    ...
    @Configuration
    public static class MySongListPicConfig implements WebMvcConfigurer {
        @Override
    ...
    public Object updateSongListMsg(HttpServletRequest req) {
        ...
        boolean res = songListService.updateSongListMsg(title,introduction,style,id);
        if (res) {
    ...
    public Object updateSongListPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id") int id) {
        ...
        try {
            ...
            boolean res = songListService.updateSongListImg(imgPath,id);
            if (res) {
