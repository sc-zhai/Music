...
import haut.zsc.music.service.Impl.CommentServiceImpl;
...
public class CommentController {
    ...
    public Object addCommentToSong(HttpServletRequest req) {
        ...
        if (comment.getType().byteValue() == 0) {
            comment.setSongId(Integer.parseInt(song_id));
        } else if (comment.getType().byteValue() == 1) {
